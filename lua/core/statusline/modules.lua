-- TODO: Add correct highlight groups
...
M.git = function()
	...
	local branch_name = " 󰊢 " .. git_status.head .. " "
...
M.linters_status = function()
	...
	for _, client in ipairs(nvim_lint._resolve_linter_by_ft(vim.bo.filetype)) do
		if client_names == "" then
			client_names = client
		else
	...
	return ("%#StatusLSPStatus#" .. "<󰨮 " .. client_names .. " /> ")
end
...
M.formatters_status = function()
	...
	return ("%#StatusLSPStatus#" .. "<󰸱 " .. client_names .. " /> ")
end

M.cwd = function()
	local dir_icon = "%#StatusCwd#" .. " 󰉋 "
	local dir_name = "%#StatusCwd#" .. vim.fn.fnamemodify(vim.fn.getcwd(), ":t") .. " "
